from salvador import define_discriminator, define_gan, define_generator, load_real_samples, train, \
    create_gif, remove_plots, remove_models, plot_history, generate_fake_samples
...
# train(d_loss_real_hist, d_loss_fake_hist, g_loss_hist, g_model, d_model, gan_model, dataset, latent_dim, n_epochs=11, n_batch=n_batch_for_real)
